...
<head>
    ...
    <link rel="stylesheet" href="foodwaste.css?v=2">
...
<header class="header-section">
    <div class="container text-center">
        <h1>Food Waste and Hunger in India</h1>
        <p>Addressing Critical Issues: Food Waste, Hunger, and Sustainability</p>
    </div>
</header>
...
<section class="content-section">
    <div class="container">
        ...
        <p>India faces two critical challenges: food waste and hunger. Despite being a major agricultural producer, large amounts of food are wasted annually due to inefficiencies in supply chains, storage, and consumption. This page highlights the challenges of food waste and hunger, the efforts being made to address them, and how we all can contribute to solving these issues.</p>
    </div>
</section>

<!-- Food Waste in India Section -->
<section class="content-section">
    <div class="container">
        <h2 class="section-title">Food Waste in India</h2>
        <p>Food waste in India has reached alarming proportions, with an estimated 74 million tonnes of food lost annually. This waste accounts for 22% of India’s food grain output. Much of this loss occurs due to inefficient supply chains, improper storage, and waste at the consumer level, particularly in restaurants and markets.</p>
        <p>Key factors contributing to food waste include poor storage facilities, lack of refrigerated transport, and the increase in processed food consumption. A large portion of perishable goods such as fruits, vegetables, and dairy products are discarded. This is further compounded by the lack of awareness around food wastage in urban and rural areas.</p>
        <p>The environmental impact of food waste in India is also significant, contributing to unnecessary greenhouse gas emissions that exacerbate the climate crisis. By focusing on education, better storage practices, and food redistribution programs, we can minimize this waste.</p>
    </div>
</section>

<!-- Hunger Crisis in India Section -->
<section class="content-section">
    <div class="container">
        <h2 class="section-title">The Hunger Crisis in India</h2>
        <p>Despite economic growth, hunger remains a severe problem in India. According to the Global Hunger Index, India ranks 101st out of 116 countries. Approximately 190 million people in India were undernourished as of 2020, and many face food insecurity, particularly in rural areas.</p>
        <p>The COVID-19 pandemic worsened the situation, disrupting food supply chains and increasing the number of people facing hunger. Agricultural practices, storage infrastructure, and food distribution networks are key areas that require improvement to address food insecurity and ensure adequate nutrition for all citizens.</p>
    </div>
</section>
...
<section class="content-section">
    <div class="container">
        <h2 class="section-title">Government Initiatives to Tackle Hunger</h2>
        <p>The Government of India has launched several programs to address hunger and food insecurity. The Public Distribution System (PDS) is a nationwide initiative that provides subsidized food grains to eligible households. In addition, the National Food Security Act (NFSA) aims to reach 80% of rural populations and 50% of urban populations, providing essential food items at subsidized rates.</p>
        <p>Other programs such as midday meals in schools and food assistance for migrant workers during emergencies have played a crucial role in improving food access. However, more work is needed to ensure that food reaches those who need it most, particularly in rural and marginalized urban communities.</p>
    </div>
</section>
