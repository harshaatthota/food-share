...
// Fetch admin profile
$query = "SELECT user_id, name, email_address, phone_number, profile_pic FROM admin_profiles WHERE user_id = ?";
...
// Fetch admin posts (gallery)
$query = "SELECT id, media_path FROM admin_posts WHERE user_id = ? ORDER BY created_at DESC";
$stmt = $conn->prepare($query);
$stmt->bind_param("s", $user_id);
$stmt->execute();
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="admin_profile.php"></i>Profile</a></li>
...
<div class="profile-container">
    <div class="profile-header">
        ...
        <div class="profile-info">
            <h2><?= htmlspecialchars($profile['name']) ?><span class="user-id">(<?= htmlspecialchars($profile['user_id']) ?>)</span></h2>
            ...
            <a href="edit_admin_profile.php" class="edit-profile">Edit Profile</a>
            <a href="admin_dashboard.php" class="back-btn">Back</a>
        </div>
    </div>

    <div class="post-section">
        <form action="upload_admin_post.php" method="post" enctype="multipart/form-data">
    ...
    <?php while ($post = $posts->fetch_assoc()): ?>
        <div class="gallery-item">
            ...
            <form action="delete_admin_post.php" method="post" class="delete-form" onsubmit="return confirmDelete()">
