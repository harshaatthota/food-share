...
$dbname = "food_share"; // Update with your DB name
...
$sql = "SELECT id, name, amount, payment_method, card_number, donated_at FROM contributions";
...
<head>
    ...
    <link rel="stylesheet" href="donation.css?v=2">
...
<nav class="navbar navbar-expand-lg custom-navbar">
    ...
    <div class="container my-5">
        <h1 class="text-center text-success mb-4">Contributions</h1>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>" . ($row['card_number'] ? '**** **** **** ' . substr($row['card_number'], -4) : 'N/A') . "</td>
                                    <td>{$row['donated_at']}</td>
                                  </tr>";
                        }
                    } else {
                        echo "<tr><td colspan='6' class='text-center'>No contributions found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
